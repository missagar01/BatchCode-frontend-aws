...
const CONFIG = {
    ...
    APPS_SCRIPT_URL:
        "https://script.google.com/macros/s/AKfycbwA_6R16crOrUOwYyL05LA85lIUmejYVvVXWyYzkc-Pt5vDeT_dHhtpuvy5FoFNGATd/exec",
    ...
    PAGE_CONFIG: {
        ...
        description: "Showing all Recoil Data",
        historyDescription: "",
    },
}
...
function DelegationDataPage() {
    ...
    const handleProcessClick = useCallback((account) => {
        ...
        setProcessFormData({
            hotCoilerShortCode: account["col1"] || "",
            size: account["col2"] || "",
            supervisor: account["col3"] || "",
            supervisorOther: "",
            incharge: account["col4"] || "",
            inchargeOther: "",
            contractor: account["col5"] || "",
            welderName: account["col7"] || "",
            welderNameOther: "",
            machineNumber: account["col6"] || ""
        })
    ...
    const handleProcessSubmit = useCallback(async () => {
        ...
        try {
            ...
            if (response.ok) {
                setSuccessMessage("ReCoil data processed successfully!")
            ...
            setError("Failed to process recoil data: " + error.message)
        } finally {
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                            <div className="bg-red-500 text-white p-4 rounded-t-lg flex justify-between items-center">
                                <h3 className="text-lg font-semibold">Process ReCoil Data</h3>
                            ...
                            <div className="p-6 space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            value={processFormData.hotCoilerShortCode}
                                            onChange={(e) => handleProcessFormChange("hotCoilerShortCode", e.target.value)}
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="Ramdhan Verma">Ramdhan Verma</option>
                                            <option value="Vijay Raut">Vijay Raut</option>
                                            <option value="Yogesh Choudhari">Yogesh Choudhari</option>
                                            <option value="Rajesh Lohar">Rajesh Lohar</option>
                                            <option value="Kamal Sahu">Kamal Sahu</option>
                                            <option value="Kamlesh Bisen">Kamlesh Bisen</option>
                                            <option value="Ranjit Kumar">Ranjit Kumar</option>
                                            <option value="Karmalal Nishad">Karmalal Nishad</option>
                                            <option value="Suryakant Jena">Suryakant Jena</option>
                                            <option value="Hitesh Barman">Hitesh Barman</option>
                                    ...
                                    {processFormData.supervisor === "Other" && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                                Specify Other Supervisor *
                                            </label>
                                            <input
                                                type="text"
                                                value={processFormData.supervisorOther}
                                                onChange={(e) => handleProcessFormChange("supervisorOther", e.target.value)}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                                                required={processFormData.supervisor === "Other"}
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="Toman Lal Sahu">Toman Lal Sahu</option>
                                            <option value="Ramdhan Verma">Ramdhan Verma</option>
                                            <option value="Ranjit Kumar">Ranjit Kumar</option>
                                            <option value="Other">Other</option>
                                        </select>
                                    ...
                                    {processFormData.incharge === "Other" && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                                Specify Other Incharge *
                                            </label>
                                            <input
                                                type="text"
                                                value={processFormData.inchargeOther}
                                                onChange={(e) => handleProcessFormChange("inchargeOther", e.target.value)}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                                                required={processFormData.incharge === "Other"}
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="Dhananjay (CT)">Dhananjay (CT)</option>
                                            <option value="Mumtaz (MDM)">Mumtaz (MDM)</option>
                                            <option value="Birendra Kumar (BK)">Birendra Kumar (BK)</option>
                                            <option value="Sonu Kumar (SK)">Sonu Kumar (SK)</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            value={processFormData.welderName}
                                            onChange={(e) => handleProcessFormChange("welderName", e.target.value)}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                                            required
                                        >
                                    ...
                                    {/* Welder Name Other */}
                                    {processFormData.welderName === "Other" && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                                Specify Other Welder Name *
                                            </label>
                                            <input
                                                type="text"
                                                value={processFormData.welderNameOther}
                                                onChange={(e) => handleProcessFormChange("welderNameOther", e.target.value)}
                                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                                                required={processFormData.welderName === "Other"}
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div>
                                        ...
                                        <select
                                            value={processFormData.machineNumber}
                                            onChange={(e) => handleProcessFormChange("machineNumber", e.target.value)}
                                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                                            required
                                        >
                                            <option value="">Select Machine Number</option>
                                            <option value="SRMPL01">SRMPL01</option>
                                            <option value="SRMPL02">SRMPL02</option>
                                            <option value="SRMPL03">SRMPL03</option>
                                            <option value="SRMPL04">SRMPL04</option>
                                            <option value="SRMPL05">SRMPL05</option>
                                            <option value="SRMPL06">SRMPL06</option>
                                            <option value="SRMPL07">SRMPL07</option>
                                            <option value="SRMPL08">SRMPL08</option>
                                            <option value="SRMPL09">SRMPL09</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                {filteredAccountData.length > 0 ? (
                                                    ...
                                                    <tr>
                                                        <td colSpan={10} className="px-6 py-4 text-center text-gray-500">
                                                            {searchTerm ? "No tasks matching your search" : "No Data Found"}
                                                        </td>
                                                    </tr>
                                                )}
                                            </tbody>
