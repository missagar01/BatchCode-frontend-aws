...
const CONFIG = {
    ...
    APPS_SCRIPT_URL:
        "https://script.google.com/macros/s/AKfycbw47OeeL2Bb5zYTNtdED6-YvfoGdwj2vPPLVmi5MRmuZsozmbFuLB9M2NzrYwX6E1g/exec",
    ...
    PAGE_CONFIG: {
        ...
        description: "Showing all Lab Tests Data",
...
function DelegationDataPage() {
    ...
    const handleProcessClick = useCallback((account) => {
        ...
        setProcessFormData({
            smsBatchCode: account["col1"] || "",
            sampledFurnaceNumber: account["col2"] || "",
            sampledSequence: account["col3"] || "",
            sampledLaddleNumber: account["col4"] || "",
            shift: account["col5"] || "",
            finalC: account["col6"] || "",
            finalMN: account["col7"] || "",
            finalS: account["col8"] || "",
            finalP: account["col9"] || "",
            sampleTestedBy: account["col10"] || "",
            remarks: account["col11"] || "",
            testReportPicture: null
        })
    ...
    const handleProcessSubmit = useCallback(async () => {
        ...
        try {
            ...
            if (processFormData.testReportPicture) {
                const reader = new FileReader()
                reader.onload = async () => {
                    const base64Data = reader.result
                    formData.append("testReportPicture", base64Data)
                    formData.append("pictureName", `test_report_${selectedRow._id}_${Date.now()}.jpg`)
                    ...
                    if (response.ok) {
                        setSuccessMessage("Lab test data processed successfully!")
                ...
                reader.readAsDataURL(processFormData.testReportPicture)
            } else {
            ...
            setError("Failed to process lab test data: " + error.message)
        } finally {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="bg-red-500 text-white p-4 rounded-t-lg flex justify-between items-center">
                <h3 className="text-lg font-semibold">Process Lab Test Data</h3>
            ...
            <div className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={processFormData.smsBatchCode}
                            onChange={(e) => handleProcessFormChange("smsBatchCode", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        />
                    </div>

                    {/* Sampled Furnace Number */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                            Sampled Furnace Number *
                        </label>
                        <select
                            value={processFormData.sampledFurnaceNumber}
                            onChange={(e) => handleProcessFormChange("sampledFurnaceNumber", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        >
                    ...
                    <div>
                        ...
                        <select
                            value={processFormData.sampledSequence}
                            onChange={(e) => handleProcessFormChange("sampledSequence", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        >
                    ...
                    {/* Sampled Laddle Number */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                            Sampled Laddle Number *
                        </label>
                        <select
                            value={processFormData.sampledLaddleNumber}
                            onChange={(e) => handleProcessFormChange("sampledLaddleNumber", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        >
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={processFormData.finalC}
                            onChange={(e) => handleProcessFormChange("finalC", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={processFormData.finalMN}
                            onChange={(e) => handleProcessFormChange("finalMN", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={processFormData.finalS}
                            onChange={(e) => handleProcessFormChange("finalS", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={processFormData.finalP}
                            onChange={(e) => handleProcessFormChange("finalP", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            value={processFormData.sampleTestedBy}
                            onChange={(e) => handleProcessFormChange("sampleTestedBy", e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                            required
                        >
                            <option value="">Select Tester</option>
                            <option value="Komal Sahu">Komal Sahu</option>
                            <option value="Sushil Bharti">Sushil Bharti</option>
                            <option value="Sunil Verma">Sunil Verma</option>
                            <option value="Suraj">Suraj</option>
                            <option value="Govind Sahu">Govind Sahu</option>
                            <option value="MD Mustaq">MD Mustaq</option>
                            <option value="Devendra Chetan">Devendra Chetan</option>
                            <option value="Vikash">Vikash</option>
                            <option value="Chadrakant Sahu">Chadrakant Sahu</option>
                        </select>
                    </div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex items-center gap-4">
                            <input
                                ...
                                required
                            />
                            {processFormData.testReportPicture && (
                                                            ...
                                                            >
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap">
                                                                    {account["col12"] ? (
                                                                        ...
                                                                        >
                                                                            <img
                                                                                src={account["col12"] || "/api/placeholder/32/32"}
                                                                                alt=""
                                                                                className=""
                                                                            />
                                                                            View
