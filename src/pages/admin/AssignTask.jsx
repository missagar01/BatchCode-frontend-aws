  ...
  const fetchSheetData = useCallback(async () => {
    try {
      ...
      rows.forEach((row, rowIndex) => {
        ...
        // REMOVED: Column K and L filtering condition
        // Previous code that was filtering:
        ...
        // if (!hasColumnK || !isColumnLEmpty) { return }

        // Now ALL data that passes user role check will be included
